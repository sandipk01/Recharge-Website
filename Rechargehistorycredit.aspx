<%@ Page Title="" Language="C#" MasterPageFile="~/Manage.master" AutoEventWireup="true" CodeFile="Rechargehistorycredit.aspx.cs" Inherits="Rechargehistorycredit" %>
...
&nbsp;<asp:LinkButton ID="LinkButton3" runat="server" style="text-align: right; font-weight: bold; font-style: italic;" 
    ...
    <td style="width: 800px">
        <asp:LinkButton ID="LinkButton6" runat="server" 
            style="font-weight: 700; font-style: italic" onclick="LinkButton6_Click">View Recharge Vai Wallet</asp:LinkButton>
        <br />
        <br />
...
<fieldset style="width: 658px">
            <legend style="font-weight: 700; font-style: italic; font-size: x-large; color: #FFFFFF; background-color: #0099FF; width: 288px;">
                Recharge vai&nbsp; Credit Card </legend>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:RegiConnectionString %>" 
                
                SelectCommand="SELECT * FROM [creditdata1] WHERE ([User_Name] = @User_Name)">
                <SelectParameters>
...
<br />
  ...
  <fieldset>
    <legend style="font-size: x-large; font-weight: 700; font-style: italic; color: #FFFFFF; background-color: #0099FF; width: 291px;">
        Recharge Vai&nbsp; Credit Card
    </legend>
    ...
    <asp:SqlDataSource ID="rechdataSqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:RegiConnectionString %>" 
          ...
          SelectCommand="SELECT * FROM [creditdata1] WHERE (([Amount] &gt;= @Amount) AND ([Amount] &lt;= @Amount2))">
        <SelectParameters>
