...
public partial class Rechargehistorycredit : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        str3 = "select count(*) from creditdata1  where User_Name='" + ddlusername.Text + "'";
        ...
        str6 = "select count(*) from creditdata1 where Amount>='" + ddlamount1.Text + "' and Amount<='" + ddlamount2.Text + "' ";
