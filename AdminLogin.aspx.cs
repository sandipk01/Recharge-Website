...
public partial class AdminLogin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack == true)
        {
            ...
            str3 = "select count(*) from LoginSession where User_Name='" + DropDownList1.Text + "'";
            com3 = new SqlCommand(str3, conn3);
            conn3.Open();
            count3 = Convert.ToInt16(com3.ExecuteScalar());
            lblname.Text = "Count is:" + count3;
            conn3.Close();
            ...
            str6 = "select count(*) from LoginSession where LoginDate='" + DropDownList2.Text + "' ";
            com6 = new SqlCommand(str6, conn6);
            conn6.Open();
            count6 = Convert.ToInt16(com6.ExecuteScalar());
            lbldate.Text = "Count is:" + count6;
            conn6.Close();
