<%@ Page Title="" Language="C#" MasterPageFile="~/Agreement.master" AutoEventWireup="true" CodeFile="RefundPolicy.aspx.cs" Inherits="agreement_RefundPolicy" %>
...
EasyMobileREcharge provides Recharge of Prepaid Phones (India) for personal use and not commercial use. The user in using this facility agrees to the following Terms 1. The User is solely responsible for entering the correct information ( phone number, recharge value, etc.)
2. EasyMobileREcharge is not responsible for faulty connection on the side of the user while using the Payment Option
In case the user has paid and not recieved the recharge amount, the user will have to submit complete transaction details along with contact details to customer support at EasyMobileREcharge. The matter will be resolved after cross checking with the concerned service provider vendor after which refund, if any, will be made to the users account. This process may take 10 days or longer depending on the response from the vendor.EasyMobileRecharge will not be liable for late action in such a case. 3. EasyMobileREcharge will not refund any money oncea sale has taken place. 4. The user hereby agrees that by using the facility of online recharge from EasyMobileREcharge, the user has agreed to pay out of will any extra charges on account of online service/ sale of online recharge. 

                                     Standard of User Conduct

The "User" agrres that all contents (information, data, text, photographs, videos, music, graphics and/or other materials) hosted/viewed in the "Site" are the sole responsibility of the "User" from whom such content originated. 
...
- Upload, post, transmit, share, store or otherwise make available content that would constitute, encourage or provide instructions for a criminal offence; - Upload, post, transmit, share, store or otherwise make available any unsolicited or unauthorized advertising, solicitations, promotional materials, "junk mail," "spam," "chain letters," "pyramid schemes," or any other form of solicitation; 
...
- The Site Easy Mobile Recharge is not responsible for incorrect phone entry or incorrect selection of recharge value while recharging the prepaid mobile of the user. 

- In using this Services, you must comply with all laws, all directions of a Regulator and reasonable directions of EasyMobileRecharge, you must not use, or attempt to use, the services to break any law or to miss-use another person's rights; 

- EasyMobileRecharge is not responsible for problem in recharge due to faulty internet connection, electricity failure or PC system error or any kind of problem on the side of the user during recharge process.EasyMobileRecharge is not liable for any damages in case of any delay in correcting any fault in any Service provided by the 'site'. 

- EasyMobileRecharge is not liable for any changes in talk value by the service provider or validity period by operator. EasyMobileRecharge is not liable for any problem while recharging. If the user finds a problem with the recharge value of a recharge coupon, the user will need to contact respective service provider's customer care. 

- Disputes arising out of the transactions between the user and the EasyMobileRecharge sites are subject to the jurisdiction of courts situated in Una, HP, India only. EasyMobileRecharge reserves the right to ban the users phone number from recharge on the 'site' if EasyMobileRecharge suspects any foul use/ activity/ commercial use of the recharge facility provided by the site. 

                                      Limited User
The Website EasyMobileRecharge is not for commercial use but is specifically meant for personal use only. 
...
This site and the contents hereof are provided "as is" and without warranties of any kind either expressed or implied to the fullest extent permissible pursuant to applicable law. The Site disclaims all warranties , express or implied , and conditions including, but not limited to, implied warranties of merchantability, fitness for particular purpose, title and non - infringement. Nor does multimedia warrant that the functions of this site or the functions contained in the materials of in this site will be interrupted or error - free, that defects will be corrected, or that this site or the server's that make the sites available are free of viruses or other harmful components. In no event shall multimedia and/or its licensors or suppliers be liable for any special, indirect or consequential damages or any damages whatsoever resulting form loss of use, data or profits, whether in an action of contract, negligence or other wrongful actions, arising out of or in connection with the use or performance of any products, materials or information available from this server. This "Site" in whole or in part, could include technical inaccuracies or typographical errors. Changes are periodically added to the information herein. User's continued use of this "Site" following the posting of any change or modification of the terms will mean the "User" to accept those changes or modifications. 

Copyrights and Trademark Information 

The Site's name is the property of their respective holders. The trademarks and logos may not be used in any manner without the expressed approval of all or any content featured in the site. The logos, banners and the like are trademarks of the Site. Without Site's permission, the user agrees not to display or use these in any manner. 
