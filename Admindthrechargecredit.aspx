<%@ Page Title="" Language="C#" MasterPageFile="~/Manage.master" AutoEventWireup="true" CodeFile="Admindthrechargecredit.aspx.cs" Inherits="Admindthrechargecredit" %>
...
<td>
    <asp:Button ID="btnlogout" runat="server" Text="Logout" 
        onclick="btnlogout_Click" style="color: #0099FF; height: 26px;" 
...
&nbsp;<asp:LinkButton ID="LinkButton3" runat="server" style="text-align: right; font-weight: bold; font-style: italic;" 
    ...
    <td>
        ...
        <asp:LinkButton ID="LinkButton6" runat="server" onclick="LinkButton6_Click" 
            style="font-weight: bold; font-style: italic">View DTH Recharge Vai Wallet</asp:LinkButton>
        <br />
        <br />
...
<fieldset style="width: 658px">
            <legend style="font-weight: 700; font-style: italic; font-size: x-large; color: #FFFFFF; background-color: #6699FF">
                DTH Recharge vai&nbsp; Credit Card </legend>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:RegiConnectionString %>" 
                
                
                SelectCommand="SELECT * FROM [DTHCreditPayment] WHERE ([User_Name] = @User_Name)">
                <SelectParameters>
  ...
  <fieldset>
    ...
    <asp:SqlDataSource ID="rechdataSqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:RegiConnectionString %>" 
          ...
          SelectCommand="SELECT * FROM [DTHCreditPayment] WHERE (([Amount] &gt;= @Amount) AND ([Amount] &lt;= @Amount2))">
        <SelectParameters>
