...
public partial class DTHRecharge1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
         ...
         if (!IsPostBack)
        {
            ...
            String str1;
            conn1.Open();
            str1 = "select * from DTHWallet where User_Name='" + lbluser.Text + "'";
    ...
    protected void btnproceed_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                String insertQuery = "insert into DTHWalletPay(User_Name,DTHProvider,SubscriberNo,Amount,Paymentoption,Time,Date,Status) values(@username,@dthp,@subno,@amu,@pay,@time,@date,@status)";
