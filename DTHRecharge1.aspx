<%@ Page Title="" Language="C#" MasterPageFile="~/Manage1.master" AutoEventWireup="true" CodeFile="DTHRecharge1.aspx.cs" Inherits="DTHRecharge1" %>
...
<tr>
<td style="width: 200px; height: 23px; font-style: italic; color: #0099FF;"><b>DTH Provider:</b></td>
    <td style="width: 34px; height: 23px;">
    <asp:Label ID="lbldthp" runat="server" 
            style="font-weight: bold; font-style: italic; color: #0066FF"></asp:Label></td>
</tr>
<tr>
<td style="width: 200px; font-style: italic; color: #0099FF;"><b>Subscriber Number:</b></td>
<td style="width: 34px">
    <asp:Label ID="lblsubno" runat="server" 
        style="font-weight: bold; font-style: italic; color: #0066FF"></asp:Label></td>
</tr>
<tr>
