...
public partial class admindatacard : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        str3 = "select count(*) from DatacardWalletPayment where User_Name='" + ddlusername.Text + "'";
        com3 = new SqlCommand(str3, conn3);
        conn3.Open();
        count3 = Convert.ToInt16(com3.ExecuteScalar());
        lbluserwall.Text = ddlusername.Text + "Recharge Count is:" + count3;
        conn3.Close();
        ...
        str6 = "select count(*) from DatacardWalletPayment where Amount>='" + ddlamount1.Text + "' and Amount<='" + ddlamount2.Text + "' ";
        com6 = new SqlCommand(str6, conn6);
        conn6.Open();
        count6 = Convert.ToInt16(com6.ExecuteScalar());
        lbwallet.Text = "Wallet Recharge Count is:" + count6;
        conn6.Close();
    }
    protected void LinkButton6_Click(object sender, EventArgs e)
    {
        Response.Redirect("admindatacardcredit.aspx");
    }
