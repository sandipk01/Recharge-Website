<%@ Page Title="" Language="C#" MasterPageFile="~/Account.master" AutoEventWireup="true" CodeFile="recharge3.aspx.cs" Inherits="recharge3" %>
...
<table>
<tr >
<td rowspan="2" style="width: 395px; height: 198px">
...
<table style="height: 161px; width: 337px">
<tr>
<td style="width: 200px; height: 23px; font-style: italic; color: #0099FF;"><i><b>Mobile No</b></i></td>
    <td style="width: 34px; height: 23px;">
    <asp:Label ID="lblmobino" runat="server" 
            style="font-weight: bold; font-style: italic; color: #0066FF"></asp:Label></td>
</tr>
<tr>
<td style="width: 200px; font-style: italic; color: #0099FF;"><i><b>Operator:</b></i></td>
<td style="width: 34px">
    <asp:Label ID="lblloperator" runat="server" 
        style="font-weight: bold; font-style: italic; color: #0066FF"></asp:Label></td>
</tr>
<tr>
<td style="width: 200px; font-style: italic; color: #0099FF;"><i><b>Circle:</b></i></td><td style="width: 34px">
    <asp:Label ID="lblcircle" runat="server" 
        style="font-weight: bold; font-style: italic; color: #0066FF"></asp:Label></td>
</tr>
<tr>
<td style="width: 200px; font-style: italic; color: #0099FF;"><i><b>Amount:</b></i></td><td style="width: 34px">
    <asp:Label ID="lblamount" runat="server" 
        style="font-weight: bold; font-style: italic; color: #0066FF"></asp:Label></td>
</tr>
<tr>
<td style="width: 200px; font-style: italic; color: #0099FF;"><i><b>Payment Option:</b></i></td><td>
    <asp:Label ID="lblpayoption" runat="server" 
        style="font-weight: bold; font-style: italic; color: #0066FF"></asp:Label></td>
</tr>
<tr>
<td style="width: 200px; font-style: italic; color: #0099FF;">&nbsp;</td><td>
    &nbsp;</td>
</tr>
<tr>
<td style="font-style: italic; color: #0099FF">&nbsp;</td><td>
    &nbsp;</td>
</tr>
</table>
<br />
<div style="font-size: large"><strong><em>
    ...
    <asp:CheckBox ID="CheckBox1" runat="server" 
        ...
        style="font-weight: bold; font-style: italic; color: #0099FF" /><br />
...
<br />
  <center>  &nbsp;&nbsp;&nbsp;&nbsp;  <asp:Button ID="btnproceed" runat="server" Text="proceed" 
      ...
      <asp:Button ID="btncancel" runat="server" onclick="btncancel_Click" 
          style="font-weight: 700; font-style: italic; color: #0099FF" Text="Cancel" 
          CausesValidation="False" />
      <asp:Label ID="lblsubstract" runat="server" Visible="False"></asp:Label>
      <asp:Label ID="blsuc" runat="server" Text="successful" Visible="False"></asp:Label>
...
<td style="width: 233px; height: 198px;">
    ...
    <asp:ImageButton ID="ImageButton1" runat="server" Height="186px" 
        ImageUrl="~/advertisments/askme.png" onclick="ImageButton1_Click" 
        Width="262px" />
