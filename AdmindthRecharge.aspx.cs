...
public partial class AdmindthRecharge : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        str3 = "select count(*) from DTHWalletPay where User_Name='" + DropDownList1.Text + "'";
        com3 = new SqlCommand(str3, conn3);
        conn3.Open();
        count3 = Convert.ToInt16(com3.ExecuteScalar());
        lbluserwall.Text = DropDownList1.Text + "Recharge Count is:" + count3;
        conn3.Close();
        ...
        str6 = "select count(*) from DTHWalletPay where Amount>='" + ddlamount1.Text + "' and Amount<='" + ddlamount2.Text + "' ";
    ...
    {
        Response.Redirect("Admindthrechargecredit.aspx");
    }
